        ...
        <section className="info-card mt-6 card p-7 sm:p-8">
          <div className="max-w-4xl space-y-5">
            ...
            <p className="text-base leading-8 text-[var(--muted-foreground)]">
              ...
              that matches your level. If a page makes you open too many
              options at once, that page still needs work.
            </p>
            <p className="text-base leading-8 text-[var(--muted-foreground)]">
              The same rule applies across the site: fewer links, clearer
              labeling, and stronger reasons for why each resource is worth
              opening first.
            </p>
          </div>
        </section>
