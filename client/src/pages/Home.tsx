  ...
  return (
    <div className="site-container py-10 sm:py-14">
      <section className="home-hero">
        <div className="home-hero-header">
          <div className="space-y-2">
            ...
            <p className="home-hero-description">
              Search or open a category directly.
            </p>
          </div>
          <ShareButton
            title="futile.in"
        ...
        <form onSubmit={handleSubmit} className="relative mt-6 max-w-3xl">
        ...
        <div className="home-meta-row">
          <p className="home-meta-copy">
            {liveCategories.length} categories live. {guides.length} guides.{" "}
            {totalResourceCount} resources.
          </p>
          <Link href="/categories" className="secondary-link">
            Browse all
          </Link>
        </div>
      </section>
